...
def test_hosted_mode_uses_hermes_layer_favicons():
    ...
    assert '<div class="logo"><img src="static/favicon.svg?v=hl-logo-20260609f" alt=""></div>' in ROUTES_PY
    assert 'hl-logo-20260609f' in (STATIC / "index.html").read_text(encoding="utf-8")
    assert 'hl-logo-20260609f' in (STATIC / "boot.js").read_text(encoding="utf-8")
