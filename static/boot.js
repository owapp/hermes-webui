...
function applyBotName(){
  ...
  if(logo && !logo.querySelector('img')) logo.innerHTML='<img src="static/favicon.svg?v=hl-logo-20260609e" alt="">';
...
(async()=>{
  ...
  if(!window.__hermesLayerHosted&&(_testUpdates||(_bootSettings.check_for_updates!==false&&!sessionStorage.getItem('hermes-update-checked')&&!sessionStorage.getItem('hermes-update-dismissed')))){
  ...
  if(_bootSettings.onboarding_completed&&typeof _setHostedBootBlocked==='function')_setHostedBootBlocked(false);
