...
function hostedDocumentAssistantName(){
  return window.__hermesLayerHosted ? 'Hermes Layer Agent' : assistantDisplayName();
}
...
function syncTopbar(){
  if(!S.session){
    document.title=hostedDocumentAssistantName();
