...
const LOCALES = {
  en: {
    ...
    messaging_channels_section_meta: 'Configure verified Hermes chat channels. Runtime-discovered channels stay read-only until their config shape is verified.',
    ...
    event_webhooks_section_meta: 'Review Hermes event ingress surfaces. Route and subscription editing remains read-only until the Hermes route schema is verified.',
    ...
    developer_api_section_meta: 'Configure verified external API access surfaces such as the OpenAI-compatible Hermes API server.',
