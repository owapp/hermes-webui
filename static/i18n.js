...
const LOCALES = {
  en: {
    ...
    _label: 'English',
    _speech: 'en-US',
    hl_account_menu: 'Account menu',
    hl_account_loading: 'Loading account...',
    hl_account_unavailable_reload: 'Account unavailable. Reload this page to retry.',
    hl_subscription: 'Subscription',
    hl_ai_credits: 'AI credits',
    hl_logout: 'Log out',
    hl_menu_agent_status: 'Agent status',
    hl_menu_backups: 'Backups',
    hl_menu_account: 'Account',
    hl_menu_billing: 'Billing',
    hl_menu_support: 'Support',
    hl_agent_status_title: 'Agent status',
    hl_agent_status_subtitle: 'Control your hosted Hermes Agent through Hermes Layer.',
    hl_your_hermes_agent: 'Your Hermes Agent',
    hl_agent_status_audit_notice: 'These actions are mediated by Hermes Layer and audited by the control plane.',
    hl_refresh: 'Refresh',
    hl_agent_service: 'Agent service',
    hl_health: 'Health',
    hl_billing_access: 'Billing access',
    hl_control_plane: 'Control plane',
    hl_name: 'Name',
    hl_last_check: 'Last check',
    hl_updated: 'Updated',
    hl_created: 'Created',
    hl_start_agent: 'Start agent',
    hl_restart_agent: 'Restart agent',
    hl_recover_agent: 'Recover agent',
    hl_stop_agent: 'Stop agent',
    hl_agent_status_loading: 'Loading agent status...',
    hl_agent_status_failed: 'Agent status failed.',
    hl_agent_action_requested: 'Agent action requested.',
    hl_agent_action_completed: 'Agent action completed.',
    hl_stop_agent_confirm: 'Stop this hosted Hermes Agent? Scheduled jobs and chat will pause until it is started again.',
    hl_backups_title: 'Backups',
    hl_backups_subtitle: 'Full workspace backups include Hermes/WebUI data, manifest and checksums.',
    hl_full_workspace_backup: 'Full Workspace Backup',
    hl_backup_restore_notice: 'Archives restore Hermes/WebUI data after checksum verification. Exports can be imported back into this workspace.',
    hl_create_backup: 'Create backup',
    hl_import_backup: 'Import backup',
    hl_download: 'Download',
    hl_restore: 'Restore',
    hl_no_backups_yet: 'No backups yet.',
    hl_automatic_backup: 'Automatic backup',
    hl_imported_backup: 'Imported backup',
    hl_manual_backup: 'Manual backup',
    hl_backup_created: 'Created',
    hl_backup_completed: 'Completed',
    hl_latest_size: 'Latest size',
    hl_format: 'Format',
    hl_backup_creating: 'Creating a full workspace backup...',
    hl_backup_completed_msg: 'Backup completed.',
    hl_backup_failed: 'Backup failed.',
    hl_backup_importing: 'Importing full workspace backup...',
    hl_backup_imported: 'Backup imported.',
    hl_backup_restoring: 'Restoring backup...',
    hl_backup_restored: 'Restore completed.',
    hl_backup_restore_confirm: 'Restore this workspace from backup {0}? Current agent data will be replaced.',
    hl_hosted_setup: 'HOSTED SETUP',
    hl_configure_hosted_agent: 'Configure your hosted Hermes Agent',
    hl_hosted_onboarding_intro: 'Connect a provider, choose the model and open your first hosted Hermes workspace.',
    hl_finish_later: 'Finish later',
    hl_provider_required: 'Provider required',
    hl_step_provider_setup: 'Provider setup',
    hl_step_provider_desc: 'Connect the model provider for this agent.',
    hl_step_model: 'Model',
    hl_step_model_desc: 'Choose the default model for new chats.',
    hl_step_start: 'Start',
    hl_step_start_desc: 'Review and open your agent.',
    hl_back: 'Back',
    hl_continue: 'Continue',
    hl_open_agent: 'Open Agent',
    hl_notice_connect_provider: 'Connect a provider before using your hosted Hermes Agent.',
    hl_notice_agent_ready: 'Your hosted Hermes Agent is ready to chat.',
    hl_notice_choose_model: 'Choose the model Hermes should use for new chats.',
    hl_notice_agent_opens_selected: 'Your agent opens with the selected provider and model. You can change provider settings later from WebUI preferences.',
    hl_managed_ai_credits: 'Managed AI credits',
    hl_recommended: 'Recommended',
    hl_managed_ai_no_provider: 'No provider account required. Usage is debited from your prepaid EUR balance.',
    hl_byok: 'Bring your own key',
    hl_byok_desc: 'Use OpenAI, Anthropic, OpenRouter, self-hosted endpoints or other WebUI providers.',
    hl_loading_credits: 'Loading credits...',
    hl_managed_ai_ready: 'Managed AI credits are ready.',
    hl_add_prepaid_before_continue: 'Add prepaid credits before continuing.',
    hl_available: 'Available',
    hl_minimum_topup: 'Minimum top-up',
    hl_maximum_topup: 'Maximum top-up',
    hl_topup_amount: 'Top-up amount',
    hl_add_ai_credits: 'Add AI credits',
    ...
    messaging_channels_tab_title: 'Messaging Channels',
    messaging_channels_section_title: 'Messaging Channels',
    messaging_channels_section_meta: 'Configure verified Hermes chat channels through Hermes Layer.',
    messaging_channels_configure_link: 'Configure messaging channels',
    messaging_channels_empty: 'No messaging channels are available from the Hermes runtime.',
    event_webhooks_tab_title: 'Webhooks',
    event_webhooks_section_title: 'Webhooks',
    event_webhooks_section_meta: 'Create signed public Hermes Layer webhook URLs routed to this workspace.',
    event_webhooks_empty: 'No event webhook surfaces are available from the Hermes runtime.',
    developer_api_tab_title: 'Developer API',
    developer_api_section_title: 'Developer API',
    developer_api_section_meta: 'Create scoped Hermes Layer API keys for the OpenAI-compatible workspace endpoint.',
    developer_api_empty: 'No developer API surfaces are available from the Hermes runtime.',
    connectors_refresh: 'Refresh',
    connectors_load_failed: 'Failed to load gateway surfaces.',
    connectors_runtime_running: 'Hermes gateway runtime is running.',
    connectors_runtime_error: 'Hermes gateway runtime reports an error.',
    connectors_runtime_unknown: 'Hermes gateway runtime status is unknown.',
    connectors_status_not_configured: 'Not configured',
    connectors_status_configured: 'Configured',
    connectors_status_enabled: 'Enabled',
    connectors_status_error: 'Error',
    connectors_status_unknown: 'Unknown',
    connectors_required_marker: 'required',
    connectors_enabled_yes: 'Enabled',
    connectors_enable: 'Enable',
    connectors_disable: 'Disable',
    connectors_save: 'Save',
    connectors_test: 'Check setup',
    connectors_save_webhook: 'Save webhook',
    connectors_check_webhook: 'Check webhook',
    connectors_enable_webhook: 'Enable webhook',
    connectors_disable_webhook: 'Disable webhook',
    connectors_delete_webhook: 'Delete webhook',
    connectors_docs: 'Open docs',
    connectors_no_fields: 'This surface does not expose WebUI-editable fields.',
    connectors_configure_runtime_env: 'Configure this surface in the Hermes runtime environment.',
    connectors_missing_required: 'Missing required fields: {0}',
    connectors_required_env: 'Required runtime environment: {0}',
    connectors_webhook_routes: '{0} webhook routes configured.',
    connectors_saving: 'Saving gateway surface...',
    connectors_saved: 'Gateway surface saved.',
    connectors_save_failed: 'Failed to save gateway surface.',
    connectors_updating: 'Updating gateway surface...',
    connectors_enabled_toast: 'Gateway surface enabled.',
    connectors_disabled_toast: 'Gateway surface disabled.',
    connectors_toggle_failed: 'Failed to update gateway surface.',
    connectors_testing: 'Validating gateway surface configuration...',
    connectors_test_ok: 'Gateway surface configuration is valid.',
    connectors_test_failed: 'Gateway surface validation failed.',
    connectors_public_url: 'Public URL',
    connectors_public_base_url: 'Public base URL',
    connectors_signing_secret: 'Signing secret',
    connectors_signing_secret_once: 'Save this signing secret now. It will not be shown again:',
    connectors_default_key_label: 'External client',
    connectors_create_key: 'Create API key',
    connectors_creating_key: 'Creating API key...',
    connectors_api_key_created: 'Save this API key now. It will not be shown again:',
    connectors_api_key_created_toast: 'Developer API key created.',
    connectors_create_key_failed: 'Failed to create Developer API key.',
    connectors_key_name: 'Key name',
    connectors_key_name_help: 'Used only to identify this key later.',
    connectors_developer_api_help: 'Create a key, then use it as a Bearer token with the public base URL above.',
    connectors_check_api_access: 'Check API access',
    connectors_revoke_key: 'Revoke',
    connectors_revoking_key: 'Revoking API key...',
    connectors_key_revoked: 'Developer API key revoked.',
    connectors_revoke_key_failed: 'Failed to revoke Developer API key.',
    connectors_no_api_keys: 'No Developer API keys yet.',
    connectors_deleting_webhook: 'Deleting webhook...',
    connectors_webhook_deleted: 'Webhook deleted.',
    connectors_delete_webhook_failed: 'Failed to delete webhook.',
    connectors_delete_webhook_confirm_title: 'Delete this webhook?',
    connectors_delete_webhook_confirm_message: 'The public URL and signing secret will stop working. This cannot be undone.',
  ...
  it: {
    ...
    _label: 'Italiano',
    _speech: 'it-IT',
    hl_account_menu: 'Menu account',
    hl_account_loading: 'Caricamento account...',
    hl_account_unavailable_reload: 'Account non disponibile. Ricarica la pagina per riprovare.',
    hl_subscription: 'Abbonamento',
    hl_ai_credits: 'Crediti IA',
    hl_logout: 'Esci',
    hl_menu_agent_status: 'Stato agente',
    hl_menu_backups: 'Backup',
    hl_menu_account: 'Account',
    hl_menu_billing: 'Fatturazione',
    hl_menu_support: 'Supporto',
    hl_agent_status_title: 'Stato agente',
    hl_agent_status_subtitle: 'Controlla il tuo Hermes Agent ospitato tramite Hermes Layer.',
    hl_your_hermes_agent: 'Il tuo Hermes Agent',
    hl_agent_status_audit_notice: 'Queste azioni passano da Hermes Layer e sono registrate dal control plane.',
    hl_refresh: 'Aggiorna',
    hl_agent_service: 'Servizio agente',
    hl_health: 'Stato di salute',
    hl_billing_access: 'Accesso alla fatturazione',
    hl_control_plane: 'Control plane',
    hl_name: 'Nome',
    hl_last_check: 'Ultimo controllo',
    hl_updated: 'Aggiornato',
    hl_created: 'Creato',
    hl_start_agent: 'Avvia agente',
    hl_restart_agent: 'Riavvia agente',
    hl_recover_agent: 'Ripristina agente',
    hl_stop_agent: 'Arresta agente',
    hl_agent_status_loading: 'Caricamento stato agente...',
    hl_agent_status_failed: 'Impossibile caricare lo stato dell’agente.',
    hl_agent_action_requested: 'Richiesta inviata all’agente.',
    hl_agent_action_completed: 'Azione completata.',
    hl_stop_agent_confirm: 'Arrestare l’agente? I job in esecuzione potrebbero essere interrotti.',
    hl_backups_title: 'Backup',
    hl_backups_subtitle: 'I backup completi del workspace includono dati Hermes/WebUI, manifest e checksum.',
    hl_full_workspace_backup: 'Backup completo del workspace',
    hl_backup_restore_notice: 'Gli archivi ripristinano i dati Hermes/WebUI dopo la verifica dei checksum.',
    hl_create_backup: 'Crea backup',
    hl_import_backup: 'Importa backup',
    hl_download: 'Scarica',
    hl_restore: 'Ripristina',
    hl_no_backups_yet: 'Nessun backup ancora.',
    hl_automatic_backup: 'Backup automatico',
    hl_imported_backup: 'Backup importato',
    hl_manual_backup: 'Backup manuale',
    hl_backup_created: 'Creato',
    hl_backup_completed: 'Completato',
    hl_latest_size: 'Ultima dimensione',
    hl_format: 'Formato',
    hl_backup_creating: 'Creazione backup...',
    hl_backup_completed_msg: 'Backup completato.',
    hl_backup_failed: 'Backup non riuscito.',
    hl_backup_importing: 'Importazione backup...',
    hl_backup_imported: 'Backup importato.',
    hl_backup_restoring: 'Ripristino backup...',
    hl_backup_restored: 'Workspace ripristinato.',
    hl_backup_restore_confirm: 'Ripristinare questo backup? I dati correnti del workspace potrebbero essere sovrascritti.',
    hl_hosted_setup: 'CONFIGURAZIONE HOSTED',
    hl_configure_hosted_agent: 'Configura il tuo Hermes Agent ospitato',
    hl_hosted_onboarding_intro: 'Collega un provider, scegli il modello e apri il tuo primo workspace Hermes ospitato.',
    hl_finish_later: 'Completa più tardi',
    hl_provider_required: 'Provider richiesto',
    hl_step_provider_setup: 'Configurazione provider',
    hl_step_provider_desc: 'Collega il provider del modello per questo agente.',
    hl_step_model: 'Modello',
    hl_step_model_desc: 'Scegli il modello predefinito per le nuove chat.',
    hl_step_start: 'Avvia',
    hl_step_start_desc: 'Controlla e apri il tuo agente.',
    hl_back: 'Indietro',
    hl_continue: 'Continua',
    hl_open_agent: 'Apri agente',
    hl_notice_connect_provider: 'Collega un provider prima di usare il tuo Hermes Agent ospitato.',
    hl_notice_agent_ready: 'Il tuo Hermes Agent ospitato è pronto per chattare.',
    hl_notice_choose_model: 'Scegli il modello che Hermes deve usare per le nuove chat.',
    hl_notice_agent_opens_selected: 'Il tuo agente si aprirà con il provider e il modello selezionati.',
    hl_managed_ai_credits: 'Crediti IA gestiti',
    hl_recommended: 'Consigliato',
    hl_managed_ai_no_provider: 'Nessun account provider richiesto. L’utilizzo viene scalato dal tuo saldo EUR prepagato.',
    hl_byok: 'Usa la tua chiave',
    hl_byok_desc: 'Usa OpenAI, Anthropic, OpenRouter o un provider compatibile.',
    hl_loading_credits: 'Caricamento crediti...',
    hl_managed_ai_ready: 'I crediti IA gestiti sono pronti.',
    hl_add_prepaid_before_continue: 'Aggiungi crediti prepagati prima di continuare.',
    hl_available: 'Disponibile',
    hl_minimum_topup: 'Ricarica minima',
    hl_maximum_topup: 'Ricarica massima',
    hl_topup_amount: 'Importo ricarica',
    hl_add_ai_credits: 'Aggiungi crediti IA',
  ...
  ja: {
    ...
    _label: '日本語',
    _speech: 'ja-JP',
    hl_account_menu: 'アカウントメニュー',
    hl_account_loading: 'アカウントを読み込み中...',
    hl_account_unavailable_reload: 'アカウントを利用できません。ページを再読み込みしてください。',
    hl_subscription: 'サブスクリプション',
    hl_ai_credits: 'AIクレジット',
    hl_logout: 'ログアウト',
    hl_menu_agent_status: 'エージェント状態',
    hl_menu_backups: 'バックアップ',
    hl_menu_account: 'アカウント',
    hl_menu_billing: '請求',
    hl_menu_support: 'サポート',
    hl_agent_status_title: 'エージェント状態',
    hl_agent_status_subtitle: 'Hermes Layer を通じてホスト型 Hermes Agent を管理します。',
    hl_your_hermes_agent: 'あなたの Hermes Agent',
    hl_agent_status_audit_notice: 'これらの操作は Hermes Layer を介して実行され、コントロールプレーンで監査されます。',
    hl_refresh: '更新',
    hl_agent_service: 'エージェントサービス',
    hl_health: 'ヘルス状態',
    hl_billing_access: '請求アクセス',
    hl_control_plane: 'コントロールプレーン',
    hl_name: '名前',
    hl_last_check: '最終確認',
    hl_updated: '更新日時',
    hl_created: '作成日時',
    hl_start_agent: 'エージェントを起動',
    hl_restart_agent: 'エージェントを再起動',
    hl_recover_agent: 'エージェントを復旧',
    hl_stop_agent: 'エージェントを停止',
    hl_agent_status_loading: 'エージェント状態を読み込み中...',
    hl_agent_status_failed: 'エージェント状態を読み込めませんでした。',
    hl_agent_action_requested: 'エージェント操作をリクエストしました。',
    hl_agent_action_completed: '操作が完了しました。',
    hl_stop_agent_confirm: 'エージェントを停止しますか？実行中のジョブが中断される可能性があります。',
    hl_backups_title: 'バックアップ',
    hl_backups_subtitle: 'フルワークスペースバックアップには Hermes/WebUI データ、マニフェスト、チェックサムが含まれます。',
    hl_full_workspace_backup: 'フルワークスペースバックアップ',
    hl_backup_restore_notice: 'アーカイブはチェックサム検証後に Hermes/WebUI データを復元します。',
    hl_create_backup: 'バックアップを作成',
    hl_import_backup: 'バックアップをインポート',
    hl_download: 'ダウンロード',
    hl_restore: '復元',
    hl_no_backups_yet: 'バックアップはまだありません。',
    hl_automatic_backup: '自動バックアップ',
    hl_imported_backup: 'インポート済みバックアップ',
    hl_manual_backup: '手動バックアップ',
    hl_backup_created: '作成済み',
    hl_backup_completed: '完了',
    hl_latest_size: '最新サイズ',
    hl_format: '形式',
    hl_backup_creating: 'バックアップを作成中...',
    hl_backup_completed_msg: 'バックアップが完了しました。',
    hl_backup_failed: 'バックアップに失敗しました。',
    hl_backup_importing: 'バックアップをインポート中...',
    hl_backup_imported: 'バックアップをインポートしました。',
    hl_backup_restoring: 'バックアップを復元中...',
    hl_backup_restored: 'ワークスペースを復元しました。',
    hl_backup_restore_confirm: 'このバックアップを復元しますか？現在のワークスペースデータが上書きされる可能性があります。',
    hl_hosted_setup: 'ホスト型セットアップ',
    hl_configure_hosted_agent: 'ホスト型 Hermes Agent を設定',
    hl_hosted_onboarding_intro: 'プロバイダーを接続し、モデルを選択して、最初のホスト型 Hermes ワークスペースを開きます。',
    hl_finish_later: '後で完了',
    hl_provider_required: 'プロバイダーが必要です',
    hl_step_provider_setup: 'プロバイダー設定',
    hl_step_provider_desc: 'このエージェントで使うモデルプロバイダーを接続します。',
    hl_step_model: 'モデル',
    hl_step_model_desc: '新しいチャットのデフォルトモデルを選択します。',
    hl_step_start: '開始',
    hl_step_start_desc: '確認してエージェントを開きます。',
    hl_back: '戻る',
    hl_continue: '続行',
    hl_open_agent: 'エージェントを開く',
    hl_notice_connect_provider: 'ホスト型 Hermes Agent を使用する前にプロバイダーを接続してください。',
    hl_notice_agent_ready: 'ホスト型 Hermes Agent はチャットの準備ができています。',
    hl_notice_choose_model: '新しいチャットで Hermes が使うモデルを選択してください。',
    hl_notice_agent_opens_selected: '選択したプロバイダーとモデルでエージェントが開きます。',
    hl_managed_ai_credits: 'マネージドAIクレジット',
    hl_recommended: '推奨',
    hl_managed_ai_no_provider: 'プロバイダーアカウントは不要です。使用量は前払いのEUR残高から差し引かれます。',
    hl_byok: '自分のキーを使用',
    hl_byok_desc: 'OpenAI、Anthropic、OpenRouter、または互換APIキーを使用します。',
    hl_loading_credits: 'クレジットを読み込み中...',
    hl_managed_ai_ready: 'マネージドAIクレジットの準備ができました。',
    hl_add_prepaid_before_continue: '続行する前に前払いクレジットを追加してください。',
    hl_available: '利用可能',
    hl_minimum_topup: '最低チャージ額',
    hl_maximum_topup: '最大チャージ額',
    hl_topup_amount: 'チャージ金額',
    hl_add_ai_credits: 'AIクレジットを追加',
  ...
  ru: {
    ...
    _label: 'Русский',
    _speech: 'ru-RU',
    hl_account_menu: 'Меню аккаунта',
    hl_account_loading: 'Загрузка аккаунта...',
    hl_account_unavailable_reload: 'Аккаунт недоступен. Перезагрузите страницу, чтобы повторить попытку.',
    hl_subscription: 'Подписка',
    hl_ai_credits: 'Кредиты ИИ',
    hl_logout: 'Выйти',
    hl_menu_agent_status: 'Состояние агента',
    hl_menu_backups: 'Резервные копии',
    hl_menu_account: 'Аккаунт',
    hl_menu_billing: 'Оплата',
    hl_menu_support: 'Поддержка',
    hl_agent_status_title: 'Состояние агента',
    hl_agent_status_subtitle: 'Управляйте размещённым Hermes Agent через Hermes Layer.',
    hl_your_hermes_agent: 'Ваш Hermes Agent',
    hl_agent_status_audit_notice: 'Эти действия выполняются через Hermes Layer и аудитируются контрольным уровнем.',
    hl_refresh: 'Обновить',
    hl_agent_service: 'Сервис агента',
    hl_health: 'Состояние',
    hl_billing_access: 'Доступ к оплате',
    hl_control_plane: 'Контрольный уровень',
    hl_name: 'Название',
    hl_last_check: 'Последняя проверка',
    hl_updated: 'Обновлено',
    hl_created: 'Создано',
    hl_start_agent: 'Запустить агента',
    hl_restart_agent: 'Перезапустить агента',
    hl_recover_agent: 'Восстановить агента',
    hl_stop_agent: 'Остановить агента',
    hl_agent_status_loading: 'Загрузка состояния агента...',
    hl_agent_status_failed: 'Не удалось загрузить состояние агента.',
    hl_agent_action_requested: 'Запрос на действие отправлен агенту.',
    hl_agent_action_completed: 'Действие выполнено.',
    hl_stop_agent_confirm: 'Остановить агента? Выполняющиеся задачи могут быть прерваны.',
    hl_backups_title: 'Резервные копии',
    hl_backups_subtitle: 'Полные резервные копии workspace включают данные Hermes/WebUI, манифест и контрольные суммы.',
    hl_full_workspace_backup: 'Полная резервная копия workspace',
    hl_backup_restore_notice: 'Архивы восстанавливают данные Hermes/WebUI после проверки контрольных сумм.',
    hl_create_backup: 'Создать резервную копию',
    hl_import_backup: 'Импортировать резервную копию',
    hl_download: 'Скачать',
    hl_restore: 'Восстановить',
    hl_no_backups_yet: 'Резервных копий пока нет.',
    hl_automatic_backup: 'Автоматическая резервная копия',
    hl_imported_backup: 'Импортированная резервная копия',
    hl_manual_backup: 'Ручная резервная копия',
    hl_backup_created: 'Создано',
    hl_backup_completed: 'Завершено',
    hl_latest_size: 'Последний размер',
    hl_format: 'Формат',
    hl_backup_creating: 'Создание резервной копии...',
    hl_backup_completed_msg: 'Резервная копия создана.',
    hl_backup_failed: 'Не удалось создать резервную копию.',
    hl_backup_importing: 'Импорт резервной копии...',
    hl_backup_imported: 'Резервная копия импортирована.',
    hl_backup_restoring: 'Восстановление резервной копии...',
    hl_backup_restored: 'Workspace восстановлен.',
    hl_backup_restore_confirm: 'Восстановить эту резервную копию? Текущие данные workspace могут быть перезаписаны.',
    hl_hosted_setup: 'НАСТРОЙКА ХОСТИНГА',
    hl_configure_hosted_agent: 'Настройте размещённый Hermes Agent',
    hl_hosted_onboarding_intro: 'Подключите провайдера, выберите модель и откройте первый размещённый Hermes workspace.',
    hl_finish_later: 'Завершить позже',
    hl_provider_required: 'Требуется провайдер',
    hl_step_provider_setup: 'Настройка провайдера',
    hl_step_provider_desc: 'Подключите провайдера модели для этого агента.',
    hl_step_model: 'Модель',
    hl_step_model_desc: 'Выберите модель по умолчанию для новых чатов.',
    hl_step_start: 'Запуск',
    hl_step_start_desc: 'Проверьте настройки и откройте агента.',
    hl_back: 'Назад',
    hl_continue: 'Продолжить',
    hl_open_agent: 'Открыть агента',
    hl_notice_connect_provider: 'Подключите провайдера перед использованием размещённого Hermes Agent.',
    hl_notice_agent_ready: 'Размещённый Hermes Agent готов к чату.',
    hl_notice_choose_model: 'Выберите модель, которую Hermes будет использовать для новых чатов.',
    hl_notice_agent_opens_selected: 'Агент откроется с выбранным провайдером и моделью.',
    hl_managed_ai_credits: 'Управляемые кредиты ИИ',
    hl_recommended: 'Рекомендуется',
    hl_managed_ai_no_provider: 'Аккаунт провайдера не требуется. Использование списывается с вашего предоплаченного баланса в EUR.',
    hl_byok: 'Использовать свой ключ',
    hl_byok_desc: 'Используйте OpenAI, Anthropic, OpenRouter или совместимый API-ключ.',
    hl_loading_credits: 'Загрузка кредитов...',
    hl_managed_ai_ready: 'Управляемые кредиты ИИ готовы.',
    hl_add_prepaid_before_continue: 'Пополните предоплаченные кредиты перед продолжением.',
    hl_available: 'Доступно',
    hl_minimum_topup: 'Минимальное пополнение',
    hl_maximum_topup: 'Максимальное пополнение',
    hl_topup_amount: 'Сумма пополнения',
    hl_add_ai_credits: 'Добавить кредиты ИИ',
  ...
  es: {
    ...
    _label: 'Español',
    _speech: 'es-ES',
    hl_account_menu: 'Menú de cuenta',
    hl_account_loading: 'Cargando cuenta...',
    hl_account_unavailable_reload: 'Cuenta no disponible. Recarga esta página para intentarlo de nuevo.',
    hl_subscription: 'Suscripción',
    hl_ai_credits: 'Créditos de IA',
    hl_logout: 'Cerrar sesión',
    hl_menu_agent_status: 'Estado del agente',
    hl_menu_backups: 'Copias de seguridad',
    hl_menu_account: 'Cuenta',
    hl_menu_billing: 'Facturación',
    hl_menu_support: 'Soporte',
    hl_agent_status_title: 'Estado del agente',
    hl_agent_status_subtitle: 'Controla tu Hermes Agent alojado mediante Hermes Layer.',
    hl_your_hermes_agent: 'Tu Hermes Agent',
    hl_agent_status_audit_notice: 'Estas acciones pasan por Hermes Layer y quedan auditadas por el plano de control.',
    hl_refresh: 'Actualizar',
    hl_agent_service: 'Servicio del agente',
    hl_health: 'Estado',
    hl_billing_access: 'Acceso a facturación',
    hl_control_plane: 'Plano de control',
    hl_name: 'Nombre',
    hl_last_check: 'Última comprobación',
    hl_updated: 'Actualizado',
    hl_created: 'Creado',
    hl_start_agent: 'Iniciar agente',
    hl_restart_agent: 'Reiniciar agente',
    hl_recover_agent: 'Recuperar agente',
    hl_stop_agent: 'Detener agente',
    hl_agent_status_loading: 'Cargando estado del agente...',
    hl_agent_status_failed: 'No se pudo cargar el estado del agente.',
    hl_agent_action_requested: 'Solicitud enviada al agente.',
    hl_agent_action_completed: 'Acción completada.',
    hl_stop_agent_confirm: '¿Detener el agente? Los trabajos en ejecución podrían interrumpirse.',
    hl_backups_title: 'Copias de seguridad',
    hl_backups_subtitle: 'Las copias completas del workspace incluyen datos de Hermes/WebUI, manifiesto y checksums.',
    hl_full_workspace_backup: 'Copia completa del workspace',
    hl_backup_restore_notice: 'Los archivos restauran los datos de Hermes/WebUI después de verificar los checksums.',
    hl_create_backup: 'Crear copia',
    hl_import_backup: 'Importar copia',
    hl_download: 'Descargar',
    hl_restore: 'Restaurar',
    hl_no_backups_yet: 'Aún no hay copias de seguridad.',
    hl_automatic_backup: 'Copia automática',
    hl_imported_backup: 'Copia importada',
    hl_manual_backup: 'Copia manual',
    hl_backup_created: 'Creado',
    hl_backup_completed: 'Completado',
    hl_latest_size: 'Tamaño más reciente',
    hl_format: 'Formato',
    hl_backup_creating: 'Creando copia...',
    hl_backup_completed_msg: 'Copia completada.',
    hl_backup_failed: 'Error al crear la copia.',
    hl_backup_importing: 'Importando copia...',
    hl_backup_imported: 'Copia importada.',
    hl_backup_restoring: 'Restaurando copia...',
    hl_backup_restored: 'Workspace restaurado.',
    hl_backup_restore_confirm: '¿Restaurar esta copia? Los datos actuales del workspace podrían sobrescribirse.',
    hl_hosted_setup: 'CONFIGURACIÓN ALOJADA',
    hl_configure_hosted_agent: 'Configura tu Hermes Agent alojado',
    hl_hosted_onboarding_intro: 'Conecta un proveedor, elige el modelo y abre tu primer workspace Hermes alojado.',
    hl_finish_later: 'Terminar más tarde',
    hl_provider_required: 'Proveedor requerido',
    hl_step_provider_setup: 'Configuración del proveedor',
    hl_step_provider_desc: 'Conecta el proveedor del modelo para este agente.',
    hl_step_model: 'Modelo',
    hl_step_model_desc: 'Elige el modelo predeterminado para nuevos chats.',
    hl_step_start: 'Inicio',
    hl_step_start_desc: 'Revisa y abre tu agente.',
    hl_back: 'Atrás',
    hl_continue: 'Continuar',
    hl_open_agent: 'Abrir agente',
    hl_notice_connect_provider: 'Conecta un proveedor antes de usar tu Hermes Agent alojado.',
    hl_notice_agent_ready: 'Tu Hermes Agent alojado está listo para chatear.',
    hl_notice_choose_model: 'Elige el modelo que Hermes debe usar para nuevos chats.',
    hl_notice_agent_opens_selected: 'Tu agente se abrirá con el proveedor y el modelo seleccionados.',
    hl_managed_ai_credits: 'Créditos de IA gestionados',
    hl_recommended: 'Recomendado',
    hl_managed_ai_no_provider: 'No se requiere cuenta de proveedor. El uso se descuenta de tu saldo prepago en EUR.',
    hl_byok: 'Usar tu propia clave',
    hl_byok_desc: 'Usa OpenAI, Anthropic, OpenRouter o una clave API compatible.',
    hl_loading_credits: 'Cargando créditos...',
    hl_managed_ai_ready: 'Los créditos de IA gestionados están listos.',
    hl_add_prepaid_before_continue: 'Añade créditos prepagos antes de continuar.',
    hl_available: 'Disponible',
    hl_minimum_topup: 'Recarga mínima',
    hl_maximum_topup: 'Recarga máxima',
    hl_topup_amount: 'Importe de recarga',
    hl_add_ai_credits: 'Añadir créditos de IA',
  ...
  de: {
    ...
    _label: 'Deutsch',
    _speech: 'de-DE',
    hl_account_menu: 'Kontomenü',
    hl_account_loading: 'Konto wird geladen...',
    hl_account_unavailable_reload: 'Konto nicht verfügbar. Lade die Seite neu, um es erneut zu versuchen.',
    hl_subscription: 'Abonnement',
    hl_ai_credits: 'KI-Guthaben',
    hl_logout: 'Abmelden',
    hl_menu_agent_status: 'Agentenstatus',
    hl_menu_backups: 'Backups',
    hl_menu_account: 'Konto',
    hl_menu_billing: 'Abrechnung',
    hl_menu_support: 'Support',
    hl_agent_status_title: 'Agentenstatus',
    hl_agent_status_subtitle: 'Steuere deinen gehosteten Hermes Agent über Hermes Layer.',
    hl_your_hermes_agent: 'Dein Hermes Agent',
    hl_agent_status_audit_notice: 'Diese Aktionen laufen über Hermes Layer und werden vom Control Plane auditiert.',
    hl_refresh: 'Aktualisieren',
    hl_agent_service: 'Agentendienst',
    hl_health: 'Zustand',
    hl_billing_access: 'Abrechnungszugriff',
    hl_control_plane: 'Control Plane',
    hl_name: 'Name',
    hl_last_check: 'Letzte Prüfung',
    hl_updated: 'Aktualisiert',
    hl_created: 'Erstellt',
    hl_start_agent: 'Agent starten',
    hl_restart_agent: 'Agent neu starten',
    hl_recover_agent: 'Agent wiederherstellen',
    hl_stop_agent: 'Agent stoppen',
    hl_agent_status_loading: 'Agentenstatus wird geladen...',
    hl_agent_status_failed: 'Agentenstatus konnte nicht geladen werden.',
    hl_agent_action_requested: 'Agentenaktion wurde angefordert.',
    hl_agent_action_completed: 'Aktion abgeschlossen.',
    hl_stop_agent_confirm: 'Agent stoppen? Laufende Jobs könnten unterbrochen werden.',
    hl_backups_title: 'Backups',
    hl_backups_subtitle: 'Vollständige Workspace-Backups enthalten Hermes/WebUI-Daten, Manifest und Prüfsummen.',
    hl_full_workspace_backup: 'Vollständiges Workspace-Backup',
    hl_backup_restore_notice: 'Archive stellen Hermes/WebUI-Daten nach Prüfung der Prüfsummen wieder her.',
    hl_create_backup: 'Backup erstellen',
    hl_import_backup: 'Backup importieren',
    hl_download: 'Herunterladen',
    hl_restore: 'Wiederherstellen',
    hl_no_backups_yet: 'Noch keine Backups.',
    hl_automatic_backup: 'Automatisches Backup',
    hl_imported_backup: 'Importiertes Backup',
    hl_manual_backup: 'Manuelles Backup',
    hl_backup_created: 'Erstellt',
    hl_backup_completed: 'Abgeschlossen',
    hl_latest_size: 'Neueste Größe',
    hl_format: 'Format',
    hl_backup_creating: 'Backup wird erstellt...',
    hl_backup_completed_msg: 'Backup abgeschlossen.',
    hl_backup_failed: 'Backup fehlgeschlagen.',
    hl_backup_importing: 'Backup wird importiert...',
    hl_backup_imported: 'Backup importiert.',
    hl_backup_restoring: 'Backup wird wiederhergestellt...',
    hl_backup_restored: 'Workspace wiederhergestellt.',
    hl_backup_restore_confirm: 'Dieses Backup wiederherstellen? Aktuelle Workspace-Daten könnten überschrieben werden.',
    hl_hosted_setup: 'HOSTED SETUP',
    hl_configure_hosted_agent: 'Gehosteten Hermes Agent konfigurieren',
    hl_hosted_onboarding_intro: 'Verbinde einen Provider, wähle das Modell und öffne deinen ersten gehosteten Hermes Workspace.',
    hl_finish_later: 'Später fertigstellen',
    hl_provider_required: 'Provider erforderlich',
    hl_step_provider_setup: 'Provider-Einrichtung',
    hl_step_provider_desc: 'Verbinde den Modellprovider für diesen Agenten.',
    hl_step_model: 'Modell',
    hl_step_model_desc: 'Wähle das Standardmodell für neue Chats.',
    hl_step_start: 'Start',
    hl_step_start_desc: 'Prüfen und Agent öffnen.',
    hl_back: 'Zurück',
    hl_continue: 'Weiter',
    hl_open_agent: 'Agent öffnen',
    hl_notice_connect_provider: 'Verbinde einen Provider, bevor du deinen gehosteten Hermes Agent verwendest.',
    hl_notice_agent_ready: 'Dein gehosteter Hermes Agent ist bereit zum Chatten.',
    hl_notice_choose_model: 'Wähle das Modell, das Hermes für neue Chats verwenden soll.',
    hl_notice_agent_opens_selected: 'Dein Agent öffnet sich mit dem ausgewählten Provider und Modell.',
    hl_managed_ai_credits: 'Verwaltetes KI-Guthaben',
    hl_recommended: 'Empfohlen',
    hl_managed_ai_no_provider: 'Kein Provider-Konto erforderlich. Die Nutzung wird von deinem vorausbezahlten EUR-Guthaben abgezogen.',
    hl_byok: 'Eigenen Schlüssel verwenden',
    hl_byok_desc: 'Nutze OpenAI, Anthropic, OpenRouter oder einen kompatiblen API-Schlüssel.',
    hl_loading_credits: 'Guthaben wird geladen...',
    hl_managed_ai_ready: 'Verwaltetes KI-Guthaben ist bereit.',
    hl_add_prepaid_before_continue: 'Füge vorausbezahltes Guthaben hinzu, bevor du fortfährst.',
    hl_available: 'Verfügbar',
    hl_minimum_topup: 'Mindestaufladung',
    hl_maximum_topup: 'Maximale Aufladung',
    hl_topup_amount: 'Aufladebetrag',
    hl_add_ai_credits: 'KI-Guthaben hinzufügen',
  ...
  zh: {
    ...
    _label: '\u7b80\u4f53\u4e2d\u6587',
    _speech: 'zh-CN',
    hl_account_menu: '账户菜单',
    hl_account_loading: '正在加载账户...',
    hl_account_unavailable_reload: '账户不可用。请重新加载此页面后重试。',
    hl_subscription: '订阅',
    hl_ai_credits: 'AI 额度',
    hl_logout: '退出登录',
    hl_menu_agent_status: '智能体状态',
    hl_menu_backups: '备份',
    hl_menu_account: '账户',
    hl_menu_billing: '账单',
    hl_menu_support: '支持',
    hl_agent_status_title: '智能体状态',
    hl_agent_status_subtitle: '通过 Hermes Layer 控制你托管的 Hermes Agent。',
    hl_your_hermes_agent: '你的 Hermes Agent',
    hl_agent_status_audit_notice: '这些操作由 Hermes Layer 中介执行，并由控制平面审计。',
    hl_refresh: '刷新',
    hl_agent_service: '智能体服务',
    hl_health: '健康状态',
    hl_billing_access: '账单访问权限',
    hl_control_plane: '控制平面',
    hl_name: '名称',
    hl_last_check: '上次检查',
    hl_updated: '已更新',
    hl_created: '已创建',
    hl_start_agent: '启动智能体',
    hl_restart_agent: '重启智能体',
    hl_recover_agent: '恢复智能体',
    hl_stop_agent: '停止智能体',
    hl_agent_status_loading: '正在加载智能体状态...',
    hl_agent_status_failed: '无法加载智能体状态。',
    hl_agent_action_requested: '已请求智能体操作。',
    hl_agent_action_completed: '操作已完成。',
    hl_stop_agent_confirm: '要停止智能体吗？正在运行的任务可能会被中断。',
    hl_backups_title: '备份',
    hl_backups_subtitle: '完整工作区备份包含 Hermes/WebUI 数据、清单和校验和。',
    hl_full_workspace_backup: '完整工作区备份',
    hl_backup_restore_notice: '归档会在校验和验证后恢复 Hermes/WebUI 数据。',
    hl_create_backup: '创建备份',
    hl_import_backup: '导入备份',
    hl_download: '下载',
    hl_restore: '恢复',
    hl_no_backups_yet: '还没有备份。',
    hl_automatic_backup: '自动备份',
    hl_imported_backup: '已导入备份',
    hl_manual_backup: '手动备份',
    hl_backup_created: '已创建',
    hl_backup_completed: '已完成',
    hl_latest_size: '最新大小',
    hl_format: '格式',
    hl_backup_creating: '正在创建备份...',
    hl_backup_completed_msg: '备份已完成。',
    hl_backup_failed: '备份失败。',
    hl_backup_importing: '正在导入备份...',
    hl_backup_imported: '备份已导入。',
    hl_backup_restoring: '正在恢复备份...',
    hl_backup_restored: '工作区已恢复。',
    hl_backup_restore_confirm: '要恢复此备份吗？当前工作区数据可能会被覆盖。',
    hl_hosted_setup: '托管设置',
    hl_configure_hosted_agent: '配置你托管的 Hermes Agent',
    hl_hosted_onboarding_intro: '连接提供商，选择模型，然后打开你的第一个托管 Hermes 工作区。',
    hl_finish_later: '稍后完成',
    hl_provider_required: '需要提供商',
    hl_step_provider_setup: '提供商设置',
    hl_step_provider_desc: '为此智能体连接模型提供商。',
    hl_step_model: '模型',
    hl_step_model_desc: '选择新聊天的默认模型。',
    hl_step_start: '开始',
    hl_step_start_desc: '检查并打开你的智能体。',
    hl_back: '返回',
    hl_continue: '继续',
    hl_open_agent: '打开智能体',
    hl_notice_connect_provider: '使用托管 Hermes Agent 前，请先连接提供商。',
    hl_notice_agent_ready: '你托管的 Hermes Agent 已准备好聊天。',
    hl_notice_choose_model: '选择 Hermes 在新聊天中应使用的模型。',
    hl_notice_agent_opens_selected: '你的智能体将使用所选提供商和模型打开。',
    hl_managed_ai_credits: '托管 AI 额度',
    hl_recommended: '推荐',
    hl_managed_ai_no_provider: '无需提供商账户。使用量将从你的预付欧元余额中扣除。',
    hl_byok: '使用自己的密钥',
    hl_byok_desc: '使用 OpenAI、Anthropic、OpenRouter 或兼容的 API 密钥。',
    hl_loading_credits: '正在加载额度...',
    hl_managed_ai_ready: '托管 AI 额度已就绪。',
    hl_add_prepaid_before_continue: '继续前请先添加预付额度。',
    hl_available: '可用',
    hl_minimum_topup: '最低充值',
    hl_maximum_topup: '最高充值',
    hl_topup_amount: '充值金额',
    hl_add_ai_credits: '添加 AI 额度',
  ...
  'zh-Hant': {
    ...
    _label: '繁體中文',
    _speech: 'zh-TW',
    hl_account_menu: '帳戶選單',
    hl_account_loading: '正在載入帳戶...',
    hl_account_unavailable_reload: '帳戶無法使用。請重新載入此頁面後再試。',
    hl_subscription: '訂閱',
    hl_ai_credits: 'AI 額度',
    hl_logout: '登出',
    hl_menu_agent_status: '代理狀態',
    hl_menu_backups: '備份',
    hl_menu_account: '帳戶',
    hl_menu_billing: '帳務',
    hl_menu_support: '支援',
    hl_agent_status_title: '代理狀態',
    hl_agent_status_subtitle: '透過 Hermes Layer 控制你託管的 Hermes Agent。',
    hl_your_hermes_agent: '你的 Hermes Agent',
    hl_agent_status_audit_notice: '這些操作由 Hermes Layer 協調執行，並由控制平面稽核。',
    hl_refresh: '重新整理',
    hl_agent_service: '代理服務',
    hl_health: '健康狀態',
    hl_billing_access: '帳務存取權限',
    hl_control_plane: '控制平面',
    hl_name: '名稱',
    hl_last_check: '上次檢查',
    hl_updated: '已更新',
    hl_created: '已建立',
    hl_start_agent: '啟動代理',
    hl_restart_agent: '重新啟動代理',
    hl_recover_agent: '復原代理',
    hl_stop_agent: '停止代理',
    hl_agent_status_loading: '正在載入代理狀態...',
    hl_agent_status_failed: '無法載入代理狀態。',
    hl_agent_action_requested: '已送出代理操作請求。',
    hl_agent_action_completed: '操作已完成。',
    hl_stop_agent_confirm: '要停止代理嗎？正在執行的工作可能會被中斷。',
    hl_backups_title: '備份',
    hl_backups_subtitle: '完整工作區備份包含 Hermes/WebUI 資料、清單與校驗和。',
    hl_full_workspace_backup: '完整工作區備份',
    hl_backup_restore_notice: '封存檔會在校驗和驗證後還原 Hermes/WebUI 資料。',
    hl_create_backup: '建立備份',
    hl_import_backup: '匯入備份',
    hl_download: '下載',
    hl_restore: '還原',
    hl_no_backups_yet: '尚無備份。',
    hl_automatic_backup: '自動備份',
    hl_imported_backup: '已匯入備份',
    hl_manual_backup: '手動備份',
    hl_backup_created: '已建立',
    hl_backup_completed: '已完成',
    hl_latest_size: '最新大小',
    hl_format: '格式',
    hl_backup_creating: '正在建立備份...',
    hl_backup_completed_msg: '備份已完成。',
    hl_backup_failed: '備份失敗。',
    hl_backup_importing: '正在匯入備份...',
    hl_backup_imported: '備份已匯入。',
    hl_backup_restoring: '正在還原備份...',
    hl_backup_restored: '工作區已還原。',
    hl_backup_restore_confirm: '要還原此備份嗎？目前的工作區資料可能會被覆寫。',
    hl_hosted_setup: '託管設定',
    hl_configure_hosted_agent: '設定你託管的 Hermes Agent',
    hl_hosted_onboarding_intro: '連接供應商，選擇模型，然後開啟你的第一個託管 Hermes 工作區。',
    hl_finish_later: '稍後完成',
    hl_provider_required: '需要供應商',
    hl_step_provider_setup: '供應商設定',
    hl_step_provider_desc: '為此代理連接模型供應商。',
    hl_step_model: '模型',
    hl_step_model_desc: '選擇新聊天的預設模型。',
    hl_step_start: '開始',
    hl_step_start_desc: '檢查並開啟你的代理。',
    hl_back: '返回',
    hl_continue: '繼續',
    hl_open_agent: '開啟代理',
    hl_notice_connect_provider: '使用託管 Hermes Agent 前，請先連接供應商。',
    hl_notice_agent_ready: '你託管的 Hermes Agent 已準備好聊天。',
    hl_notice_choose_model: '選擇 Hermes 在新聊天中應使用的模型。',
    hl_notice_agent_opens_selected: '你的代理將使用所選供應商和模型開啟。',
    hl_managed_ai_credits: '託管 AI 額度',
    hl_recommended: '建議',
    hl_managed_ai_no_provider: '不需要供應商帳戶。使用量會從你的預付歐元餘額中扣除。',
    hl_byok: '使用自己的金鑰',
    hl_byok_desc: '使用 OpenAI、Anthropic、OpenRouter 或相容的 API 金鑰。',
    hl_loading_credits: '正在載入額度...',
    hl_managed_ai_ready: '託管 AI 額度已就緒。',
    hl_add_prepaid_before_continue: '繼續前請先新增預付額度。',
    hl_available: '可用',
    hl_minimum_topup: '最低儲值',
    hl_maximum_topup: '最高儲值',
    hl_topup_amount: '儲值金額',
    hl_add_ai_credits: '新增 AI 額度',
  ...
  pt: {
    ...
    _label: 'Português',
    _speech: 'pt-BR',
    hl_account_menu: 'Menu da conta',
    hl_account_loading: 'Carregando conta...',
    hl_account_unavailable_reload: 'Conta indisponível. Recarregue esta página para tentar novamente.',
    hl_subscription: 'Assinatura',
    hl_ai_credits: 'Créditos de IA',
    hl_logout: 'Sair',
    hl_menu_agent_status: 'Status do agente',
    hl_menu_backups: 'Backups',
    hl_menu_account: 'Conta',
    hl_menu_billing: 'Cobrança',
    hl_menu_support: 'Suporte',
    hl_agent_status_title: 'Status do agente',
    hl_agent_status_subtitle: 'Controle seu Hermes Agent hospedado pelo Hermes Layer.',
    hl_your_hermes_agent: 'Seu Hermes Agent',
    hl_agent_status_audit_notice: 'Estas ações passam pelo Hermes Layer e são auditadas pelo plano de controle.',
    hl_refresh: 'Atualizar',
    hl_agent_service: 'Serviço do agente',
    hl_health: 'Saúde',
    hl_billing_access: 'Acesso à cobrança',
    hl_control_plane: 'Plano de controle',
    hl_name: 'Nome',
    hl_last_check: 'Última verificação',
    hl_updated: 'Atualizado',
    hl_created: 'Criado',
    hl_start_agent: 'Iniciar agente',
    hl_restart_agent: 'Reiniciar agente',
    hl_recover_agent: 'Recuperar agente',
    hl_stop_agent: 'Parar agente',
    hl_agent_status_loading: 'Carregando status do agente...',
    hl_agent_status_failed: 'Não foi possível carregar o status do agente.',
    hl_agent_action_requested: 'Ação do agente solicitada.',
    hl_agent_action_completed: 'Ação concluída.',
    hl_stop_agent_confirm: 'Parar o agente? Jobs em execução podem ser interrompidos.',
    hl_backups_title: 'Backups',
    hl_backups_subtitle: 'Backups completos do workspace incluem dados Hermes/WebUI, manifesto e checksums.',
    hl_full_workspace_backup: 'Backup completo do workspace',
    hl_backup_restore_notice: 'Arquivos restauram dados Hermes/WebUI após verificação de checksums.',
    hl_create_backup: 'Criar backup',
    hl_import_backup: 'Importar backup',
    hl_download: 'Baixar',
    hl_restore: 'Restaurar',
    hl_no_backups_yet: 'Ainda não há backups.',
    hl_automatic_backup: 'Backup automático',
    hl_imported_backup: 'Backup importado',
    hl_manual_backup: 'Backup manual',
    hl_backup_created: 'Criado',
    hl_backup_completed: 'Concluído',
    hl_latest_size: 'Tamanho mais recente',
    hl_format: 'Formato',
    hl_backup_creating: 'Criando backup...',
    hl_backup_completed_msg: 'Backup concluído.',
    hl_backup_failed: 'Falha no backup.',
    hl_backup_importing: 'Importando backup...',
    hl_backup_imported: 'Backup importado.',
    hl_backup_restoring: 'Restaurando backup...',
    hl_backup_restored: 'Workspace restaurado.',
    hl_backup_restore_confirm: 'Restaurar este backup? Os dados atuais do workspace podem ser sobrescritos.',
    hl_hosted_setup: 'CONFIGURAÇÃO HOSPEDADA',
    hl_configure_hosted_agent: 'Configure seu Hermes Agent hospedado',
    hl_hosted_onboarding_intro: 'Conecte um provedor, escolha o modelo e abra seu primeiro workspace Hermes hospedado.',
    hl_finish_later: 'Concluir depois',
    hl_provider_required: 'Provedor obrigatório',
    hl_step_provider_setup: 'Configuração do provedor',
    hl_step_provider_desc: 'Conecte o provedor de modelo para este agente.',
    hl_step_model: 'Modelo',
    hl_step_model_desc: 'Escolha o modelo padrão para novos chats.',
    hl_step_start: 'Iniciar',
    hl_step_start_desc: 'Revise e abra seu agente.',
    hl_back: 'Voltar',
    hl_continue: 'Continuar',
    hl_open_agent: 'Abrir agente',
    hl_notice_connect_provider: 'Conecte um provedor antes de usar seu Hermes Agent hospedado.',
    hl_notice_agent_ready: 'Seu Hermes Agent hospedado está pronto para conversar.',
    hl_notice_choose_model: 'Escolha o modelo que o Hermes deve usar em novos chats.',
    hl_notice_agent_opens_selected: 'Seu agente será aberto com o provedor e o modelo selecionados.',
    hl_managed_ai_credits: 'Créditos de IA gerenciados',
    hl_recommended: 'Recomendado',
    hl_managed_ai_no_provider: 'Nenhuma conta de provedor é necessária. O uso é debitado do seu saldo pré-pago em EUR.',
    hl_byok: 'Use sua própria chave',
    hl_byok_desc: 'Use OpenAI, Anthropic, OpenRouter ou uma chave de API compatível.',
    hl_loading_credits: 'Carregando créditos...',
    hl_managed_ai_ready: 'Os créditos de IA gerenciados estão prontos.',
    hl_add_prepaid_before_continue: 'Adicione créditos pré-pagos antes de continuar.',
    hl_available: 'Disponível',
    hl_minimum_topup: 'Recarga mínima',
    hl_maximum_topup: 'Recarga máxima',
    hl_topup_amount: 'Valor da recarga',
    hl_add_ai_credits: 'Adicionar créditos de IA',
  ...
  ko: {
    ...
    _label: '한국어',
    _speech: 'ko-KR',
    hl_account_menu: '계정 메뉴',
    hl_account_loading: '계정 불러오는 중...',
    hl_account_unavailable_reload: '계정을 사용할 수 없습니다. 페이지를 새로고침해 다시 시도하세요.',
    hl_subscription: '구독',
    hl_ai_credits: 'AI 크레딧',
    hl_logout: '로그아웃',
    hl_menu_agent_status: '에이전트 상태',
    hl_menu_backups: '백업',
    hl_menu_account: '계정',
    hl_menu_billing: '결제',
    hl_menu_support: '지원',
    hl_agent_status_title: '에이전트 상태',
    hl_agent_status_subtitle: 'Hermes Layer를 통해 호스팅된 Hermes Agent를 제어합니다.',
    hl_your_hermes_agent: '내 Hermes Agent',
    hl_agent_status_audit_notice: '이 작업은 Hermes Layer를 통해 처리되며 컨트롤 플레인에서 감사됩니다.',
    hl_refresh: '새로고침',
    hl_agent_service: '에이전트 서비스',
    hl_health: '상태',
    hl_billing_access: '결제 접근 권한',
    hl_control_plane: '컨트롤 플레인',
    hl_name: '이름',
    hl_last_check: '마지막 확인',
    hl_updated: '업데이트됨',
    hl_created: '생성됨',
    hl_start_agent: '에이전트 시작',
    hl_restart_agent: '에이전트 재시작',
    hl_recover_agent: '에이전트 복구',
    hl_stop_agent: '에이전트 중지',
    hl_agent_status_loading: '에이전트 상태를 불러오는 중...',
    hl_agent_status_failed: '에이전트 상태를 불러오지 못했습니다.',
    hl_agent_action_requested: '에이전트 작업이 요청되었습니다.',
    hl_agent_action_completed: '작업이 완료되었습니다.',
    hl_stop_agent_confirm: '에이전트를 중지할까요? 실행 중인 작업이 중단될 수 있습니다.',
    hl_backups_title: '백업',
    hl_backups_subtitle: '전체 워크스페이스 백업에는 Hermes/WebUI 데이터, 매니페스트, 체크섬이 포함됩니다.',
    hl_full_workspace_backup: '전체 워크스페이스 백업',
    hl_backup_restore_notice: '아카이브는 체크섬 확인 후 Hermes/WebUI 데이터를 복원합니다.',
    hl_create_backup: '백업 생성',
    hl_import_backup: '백업 가져오기',
    hl_download: '다운로드',
    hl_restore: '복원',
    hl_no_backups_yet: '아직 백업이 없습니다.',
    hl_automatic_backup: '자동 백업',
    hl_imported_backup: '가져온 백업',
    hl_manual_backup: '수동 백업',
    hl_backup_created: '생성됨',
    hl_backup_completed: '완료됨',
    hl_latest_size: '최신 크기',
    hl_format: '형식',
    hl_backup_creating: '백업 생성 중...',
    hl_backup_completed_msg: '백업이 완료되었습니다.',
    hl_backup_failed: '백업에 실패했습니다.',
    hl_backup_importing: '백업 가져오는 중...',
    hl_backup_imported: '백업을 가져왔습니다.',
    hl_backup_restoring: '백업 복원 중...',
    hl_backup_restored: '워크스페이스가 복원되었습니다.',
    hl_backup_restore_confirm: '이 백업을 복원할까요? 현재 워크스페이스 데이터가 덮어써질 수 있습니다.',
    hl_hosted_setup: '호스팅 설정',
    hl_configure_hosted_agent: '호스팅된 Hermes Agent 설정',
    hl_hosted_onboarding_intro: '제공자를 연결하고 모델을 선택한 뒤 첫 호스팅 Hermes 워크스페이스를 여세요.',
    hl_finish_later: '나중에 완료',
    hl_provider_required: '제공자 필요',
    hl_step_provider_setup: '제공자 설정',
    hl_step_provider_desc: '이 에이전트에 사용할 모델 제공자를 연결합니다.',
    hl_step_model: '모델',
    hl_step_model_desc: '새 채팅의 기본 모델을 선택합니다.',
    hl_step_start: '시작',
    hl_step_start_desc: '검토 후 에이전트를 엽니다.',
    hl_back: '뒤로',
    hl_continue: '계속',
    hl_open_agent: '에이전트 열기',
    hl_notice_connect_provider: '호스팅된 Hermes Agent를 사용하기 전에 제공자를 연결하세요.',
    hl_notice_agent_ready: '호스팅된 Hermes Agent가 채팅할 준비가 되었습니다.',
    hl_notice_choose_model: '새 채팅에 Hermes가 사용할 모델을 선택하세요.',
    hl_notice_agent_opens_selected: '선택한 제공자와 모델로 에이전트가 열립니다.',
    hl_managed_ai_credits: '관리형 AI 크레딧',
    hl_recommended: '권장',
    hl_managed_ai_no_provider: '제공자 계정이 필요 없습니다. 사용량은 선불 EUR 잔액에서 차감됩니다.',
    hl_byok: '내 키 사용',
    hl_byok_desc: 'OpenAI, Anthropic, OpenRouter 또는 호환 API 키를 사용하세요.',
    hl_loading_credits: '크레딧 불러오는 중...',
    hl_managed_ai_ready: '관리형 AI 크레딧이 준비되었습니다.',
    hl_add_prepaid_before_continue: '계속하기 전에 선불 크레딧을 추가하세요.',
    hl_available: '사용 가능',
    hl_minimum_topup: '최소 충전액',
    hl_maximum_topup: '최대 충전액',
    hl_topup_amount: '충전 금액',
    hl_add_ai_credits: 'AI 크레딧 추가',
  ...
  fr: {
    ...
    _label: 'Français',
    _speech: 'fr-FR',
    hl_account_menu: 'Menu du compte',
    hl_account_loading: 'Chargement du compte...',
    hl_account_unavailable_reload: 'Compte indisponible. Rechargez cette page pour réessayer.',
    hl_subscription: 'Abonnement',
    hl_ai_credits: 'Crédits IA',
    hl_logout: 'Se déconnecter',
    hl_menu_agent_status: 'État de l’agent',
    hl_menu_backups: 'Sauvegardes',
    hl_menu_account: 'Compte',
    hl_menu_billing: 'Facturation',
    hl_menu_support: 'Support',
    hl_agent_status_title: 'État de l’agent',
    hl_agent_status_subtitle: 'Contrôlez votre Hermes Agent hébergé via Hermes Layer.',
    hl_your_hermes_agent: 'Votre Hermes Agent',
    hl_agent_status_audit_notice: 'Ces actions passent par Hermes Layer et sont auditées par le control plane.',
    hl_refresh: 'Actualiser',
    hl_agent_service: 'Service agent',
    hl_health: 'Santé',
    hl_billing_access: 'Accès facturation',
    hl_control_plane: 'Control plane',
    hl_name: 'Nom',
    hl_last_check: 'Dernière vérification',
    hl_updated: 'Mis à jour',
    hl_created: 'Créé',
    hl_start_agent: 'Démarrer l’agent',
    hl_restart_agent: 'Redémarrer l’agent',
    hl_recover_agent: 'Récupérer l’agent',
    hl_stop_agent: 'Arrêter l’agent',
    hl_agent_status_loading: 'Chargement de l’état de l’agent...',
    hl_agent_status_failed: 'Impossible de charger l’état de l’agent.',
    hl_agent_action_requested: 'Action demandée à l’agent.',
    hl_agent_action_completed: 'Action terminée.',
    hl_stop_agent_confirm: 'Arrêter l’agent ? Les tâches en cours peuvent être interrompues.',
    hl_backups_title: 'Sauvegardes',
    hl_backups_subtitle: 'Les sauvegardes complètes du workspace incluent les données Hermes/WebUI, le manifest et les checksums.',
    hl_full_workspace_backup: 'Sauvegarde complète du workspace',
    hl_backup_restore_notice: 'Les archives restaurent les données Hermes/WebUI après vérification des checksums.',
    hl_create_backup: 'Créer une sauvegarde',
    hl_import_backup: 'Importer une sauvegarde',
    hl_download: 'Télécharger',
    hl_restore: 'Restaurer',
    hl_no_backups_yet: 'Aucune sauvegarde pour le moment.',
    hl_automatic_backup: 'Sauvegarde automatique',
    hl_imported_backup: 'Sauvegarde importée',
    hl_manual_backup: 'Sauvegarde manuelle',
    hl_backup_created: 'Créée',
    hl_backup_completed: 'Terminée',
    hl_latest_size: 'Dernière taille',
    hl_format: 'Format',
    hl_backup_creating: 'Création de la sauvegarde...',
    hl_backup_completed_msg: 'Sauvegarde terminée.',
    hl_backup_failed: 'Échec de la sauvegarde.',
    hl_backup_importing: 'Import de la sauvegarde...',
    hl_backup_imported: 'Sauvegarde importée.',
    hl_backup_restoring: 'Restauration de la sauvegarde...',
    hl_backup_restored: 'Workspace restauré.',
    hl_backup_restore_confirm: 'Restaurer cette sauvegarde ? Les données actuelles du workspace peuvent être écrasées.',
    hl_hosted_setup: 'CONFIGURATION HÉBERGÉE',
    hl_configure_hosted_agent: 'Configurez votre Hermes Agent hébergé',
    hl_hosted_onboarding_intro: 'Connectez un provider, choisissez le modèle et ouvrez votre premier workspace Hermes hébergé.',
    hl_finish_later: 'Terminer plus tard',
    hl_provider_required: 'Provider requis',
    hl_step_provider_setup: 'Configuration provider',
    hl_step_provider_desc: 'Connectez le provider de modèle pour cet agent.',
    hl_step_model: 'Modèle',
    hl_step_model_desc: 'Choisissez le modèle par défaut pour les nouveaux chats.',
    hl_step_start: 'Démarrer',
    hl_step_start_desc: 'Vérifiez puis ouvrez votre agent.',
    hl_back: 'Retour',
    hl_continue: 'Continuer',
    hl_open_agent: 'Ouvrir l’agent',
    hl_notice_connect_provider: 'Connectez un provider avant d’utiliser votre Hermes Agent hébergé.',
    hl_notice_agent_ready: 'Votre Hermes Agent hébergé est prêt à discuter.',
    hl_notice_choose_model: 'Choisissez le modèle que Hermes doit utiliser pour les nouveaux chats.',
    hl_notice_agent_opens_selected: 'Votre agent s’ouvrira avec le provider et le modèle sélectionnés.',
    hl_managed_ai_credits: 'Crédits IA managés',
    hl_recommended: 'Recommandé',
    hl_managed_ai_no_provider: 'Aucun compte provider requis. L’utilisation est débitée de votre solde EUR prépayé.',
    hl_byok: 'Utiliser votre propre clé',
    hl_byok_desc: 'Utilisez OpenAI, Anthropic, OpenRouter ou une clé API compatible.',
    hl_loading_credits: 'Chargement des crédits...',
    hl_managed_ai_ready: 'Les crédits IA managés sont prêts.',
    hl_add_prepaid_before_continue: 'Ajoutez des crédits prépayés avant de continuer.',
    hl_available: 'Disponible',
    hl_minimum_topup: 'Recharge minimale',
    hl_maximum_topup: 'Recharge maximale',
    hl_topup_amount: 'Montant de recharge',
    hl_add_ai_credits: 'Ajouter des crédits IA',
  ...
  tr: {
    ...
    _label: 'Türkçe',
    _speech: 'tr-TR',
    hl_account_menu: 'Hesap menüsü',
    hl_account_loading: 'Hesap yükleniyor...',
    hl_account_unavailable_reload: 'Hesap kullanılamıyor. Tekrar denemek için sayfayı yenileyin.',
    hl_subscription: 'Abonelik',
    hl_ai_credits: 'Yapay zekâ kredileri',
    hl_logout: 'Oturumu kapat',
    hl_menu_agent_status: 'Ajan durumu',
    hl_menu_backups: 'Yedekler',
    hl_menu_account: 'Hesap',
    hl_menu_billing: 'Faturalandırma',
    hl_menu_support: 'Destek',
    hl_agent_status_title: 'Ajan durumu',
    hl_agent_status_subtitle: 'Barındırılan Hermes Agent’ınızı Hermes Layer üzerinden yönetin.',
    hl_your_hermes_agent: 'Hermes Agent’ınız',
    hl_agent_status_audit_notice: 'Bu işlemler Hermes Layer aracılığıyla yürütülür ve kontrol düzlemi tarafından denetlenir.',
    hl_refresh: 'Yenile',
    hl_agent_service: 'Ajan servisi',
    hl_health: 'Sağlık durumu',
    hl_billing_access: 'Faturalandırma erişimi',
    hl_control_plane: 'Kontrol düzlemi',
    hl_name: 'Ad',
    hl_last_check: 'Son kontrol',
    hl_updated: 'Güncellendi',
    hl_created: 'Oluşturuldu',
    hl_start_agent: 'Ajanı başlat',
    hl_restart_agent: 'Ajanı yeniden başlat',
    hl_recover_agent: 'Ajanı kurtar',
    hl_stop_agent: 'Ajanı durdur',
    hl_agent_status_loading: 'Ajan durumu yükleniyor...',
    hl_agent_status_failed: 'Ajan durumu yüklenemedi.',
    hl_agent_action_requested: 'Ajan işlemi istendi.',
    hl_agent_action_completed: 'İşlem tamamlandı.',
    hl_stop_agent_confirm: 'Ajan durdurulsun mu? Çalışan işler kesintiye uğrayabilir.',
    hl_backups_title: 'Yedekler',
    hl_backups_subtitle: 'Tam çalışma alanı yedekleri Hermes/WebUI verilerini, manifest dosyasını ve checksumları içerir.',
    hl_full_workspace_backup: 'Tam çalışma alanı yedeği',
    hl_backup_restore_notice: 'Arşivler, checksum doğrulamasından sonra Hermes/WebUI verilerini geri yükler.',
    hl_create_backup: 'Yedek oluştur',
    hl_import_backup: 'Yedek içe aktar',
    hl_download: 'İndir',
    hl_restore: 'Geri yükle',
    hl_no_backups_yet: 'Henüz yedek yok.',
    hl_automatic_backup: 'Otomatik yedek',
    hl_imported_backup: 'İçe aktarılmış yedek',
    hl_manual_backup: 'Manuel yedek',
    hl_backup_created: 'Oluşturuldu',
    hl_backup_completed: 'Tamamlandı',
    hl_latest_size: 'Son boyut',
    hl_format: 'Biçim',
    hl_backup_creating: 'Yedek oluşturuluyor...',
    hl_backup_completed_msg: 'Yedek tamamlandı.',
    hl_backup_failed: 'Yedekleme başarısız oldu.',
    hl_backup_importing: 'Yedek içe aktarılıyor...',
    hl_backup_imported: 'Yedek içe aktarıldı.',
    hl_backup_restoring: 'Yedek geri yükleniyor...',
    hl_backup_restored: 'Çalışma alanı geri yüklendi.',
    hl_backup_restore_confirm: 'Bu yedek geri yüklensin mi? Mevcut çalışma alanı verileri üzerine yazılabilir.',
    hl_hosted_setup: 'BARINDIRILAN KURULUM',
    hl_configure_hosted_agent: 'Barındırılan Hermes Agent’ınızı yapılandırın',
    hl_hosted_onboarding_intro: 'Bir sağlayıcı bağlayın, modeli seçin ve ilk barındırılan Hermes çalışma alanınızı açın.',
    hl_finish_later: 'Daha sonra bitir',
    hl_provider_required: 'Sağlayıcı gerekli',
    hl_step_provider_setup: 'Sağlayıcı kurulumu',
    hl_step_provider_desc: 'Bu ajan için model sağlayıcısını bağlayın.',
    hl_step_model: 'Model',
    hl_step_model_desc: 'Yeni sohbetler için varsayılan modeli seçin.',
    hl_step_start: 'Başlat',
    hl_step_start_desc: 'Kontrol edin ve ajanınızı açın.',
    hl_back: 'Geri',
    hl_continue: 'Devam et',
    hl_open_agent: 'Ajanı aç',
    hl_notice_connect_provider: 'Barındırılan Hermes Agent’ınızı kullanmadan önce bir sağlayıcı bağlayın.',
    hl_notice_agent_ready: 'Barındırılan Hermes Agent’ınız sohbet etmeye hazır.',
    hl_notice_choose_model: 'Hermes’in yeni sohbetlerde kullanacağı modeli seçin.',
    hl_notice_agent_opens_selected: 'Ajanınız seçilen sağlayıcı ve modelle açılır.',
    hl_managed_ai_credits: 'Yönetilen yapay zekâ kredileri',
    hl_recommended: 'Önerilir',
    hl_managed_ai_no_provider: 'Sağlayıcı hesabı gerekmez. Kullanım, ön ödemeli EUR bakiyenizden düşülür.',
    hl_byok: 'Kendi anahtarını kullan',
    hl_byok_desc: 'OpenAI, Anthropic, OpenRouter veya uyumlu bir API anahtarı kullanın.',
    hl_loading_credits: 'Krediler yükleniyor...',
    hl_managed_ai_ready: 'Yönetilen yapay zekâ kredileri hazır.',
    hl_add_prepaid_before_continue: 'Devam etmeden önce ön ödemeli kredi ekleyin.',
    hl_available: 'Kullanılabilir',
    hl_minimum_topup: 'Minimum yükleme',
    hl_maximum_topup: 'Maksimum yükleme',
    hl_topup_amount: 'Yükleme tutarı',
    hl_add_ai_credits: 'Yapay zekâ kredisi ekle',
